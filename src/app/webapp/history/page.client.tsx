...
import { HistoryMobile } from "@/components/pages/webapp/history/HistoryMobile";
import { HistoryDesktop } from "@/components/pages/webapp/history/HistoryDesktop";
...
const HistoryClient = ({ user, initialExpenseData }: HistoryClientProps) => {
